...
게임에 대한 더 자세한 내용은 [콘솔 사용 가이드 > 게임](./console-02-game)를 참고하세요.
...
보다 자세한 런처 설명은 [콘솔 사용 가이드 > 런처](./console-03-launcher)를 참고해주세요.
...
보다 자세한 런처 인스톨러 설명은 [콘솔 사용 가이드 > 런처 인스톨러](./console-04-installer)를 참고해주세요.
