...
>
> ➌ 게임 이름
>  게임 이름(게임 버전) 정보 리스트를 필터링해 조회할 수 있습니
>
...
**Update (OS)** 탭에서는 시간대에 따른 업데이트 설치의 OS별 지표 정보를 제공 합니다.
...
**Bounce** 탭에서는 조회 기간의 게임별 이탈률 지표 정보를 제공 합니다.
   ...
   - **Game Execution** : 게임 업데이트나 설치를 시도한 유저중 실행까지 시도한 수
